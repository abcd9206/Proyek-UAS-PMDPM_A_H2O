...
model = load_model(r"D:\Kuliah\SEMESTER 5\ML\UAS\BestModel_GoogleNet_H2O.h5")
...
st.title("Prediksi Jenis Jamur - H2O")  
    ...
    if uploaded_files:
        ...
        for uploaded_file in uploaded_files:
            ...
            if label != "Error":
                ...
                if label == "JamurKuping":
                    label_color = primary_color 
                elif label  == "JamurReishi":
                ...
                custom_progress_bar(confidence, primary_color, secondary_color, third_color)
            else:
